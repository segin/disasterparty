    ...
    int main() {
        ...
        request_config.max_tokens = 250; // Increased max_tokens for a potentially longer answer
        ...
        if (!dp_message_add_text_part(&messages[1], "Tell me about MAGIC GIANT.")) { // Updated prompt
